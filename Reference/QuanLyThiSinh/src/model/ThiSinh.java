...
public class ThiSinh implements Serializable{
	private static final long serialVersionUID = 222741889195301467L;
	...
	public String toString() {
		return "Mã thí sinh: " + maThiSinh + ", Tên thí sinh: " + tenThiSinh + ", Quê quán: " + queQuan + "Ngày sinh: "
				+ ngaySinh + "Giới tính: " + gioiTinh + ", Điểm môn 1: " + diemMon1 + ", Điểm môn 2: " + diemMon2
				+ ", Điểm môn 3: " + diemMon3;
	}
